...
<head >
    ...
    <title>Add Publication Info</title>
...
<body>
    ...
    <div>
       <!--Top Navigation bar Start-->
        ...
        <hr />
            ...
            <h1> Add information about Publication !! </h1>
	...
	<form action="FacTechAPubJob.php?id=<?php echo "$id"; ?>" method="post" >
	</form>
	
		<form action="FacTechAPubJob.php?id=<?php echo "$id"; ?>" method="post" enctype="multipart/form-data">
		<table>
		
			<tr>
				<td width="200px" height="50px"><b>Title</b></td>
				<td width="200px" height="50px"><input type="text" name="Ptitle" placeholder="Enter Name"></td>
			</tr>
			
			<tr>
				<td width="200px" height="50px"><b>Publish Date</b></td>
				<td width="200px" height="50px"><input type="date" name="Pdate" placeholder="Enter Degree"></td>
			</tr>
			...
			<tr>
				...
				<td width="200px" height="50px"><input type="url" name="Pjour" placeholder="Enter Journel link"></td>
			</tr>

			<tr>
				<td width="200px" height="50px"><b>Upload PDF file</b></td>
				<td width="200px" height="50px"> <input class="btn btn-success" type="file" name="Ppdf" > </td>
			</tr>
			...
			<tr>
				<td>
				<b><input class="btn btn-success" type="submit" name="Psub" value="Add This"></b>
				
				<a class="btn" href="ahome.php"><b> Cancel </b></a>
				</td>
			</tr>
		</table>
	</form>
