...
include('connection.php');
 ...
 $link=mysqli_connect('localhost','root','','gm2019bu');
	 ...
	 $q="select * from publication where PuID like '$PuID'";
    ...
    <div>
       <!--Top Navigation bar Start-->
        ...
        <hr />
            ...
            <h2> Confirm to Delete the publication data ?? </h2>
            ...
            <hr />
             ...
             <h2><b>Publication Name : </b> <?php echo "$PuTitle"; ?> </h2> 
			  ...
			  <h4><b>Publication Journel : </b> <i><?php echo "$PuJour"; ?> </i></h4><br><br>
			   ...
			   <a class="btn btn-large btn-success" href="FacTechSE.php"><b> Cancel </b></a>
		
		<?php echo "<a style='background-color: coral' class='btn btn-default 'href='deletePub.php?delete=$PuID'> <b> Yes , I am Confirm <b></a>" ; ?> 
		<br><br>
			  </div >
