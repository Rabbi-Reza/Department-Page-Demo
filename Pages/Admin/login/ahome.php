    ...
    <div>
       <!--Top Navigation bar Start-->
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="../../Faculty"><b>Faculty </b></a></li> 
							
							<li><a href="../../Research"><b>Research </b></a></li> 
							
							<li><a href="../../News"> <b>News & Agenda </b></a></li> 
        ...
        <hr />
			...
			<a class="btn btn-large btn-success" href="contactUniv.php">Edit University Address</a>
			
			<a class="btn btn-large btn-success" href="contactOff.php">Edit Office Room Data</a>
			
			<a class="btn btn-large btn-success" href="contactMap.php">Edit Map Location</a>
			
			 <hr>
			
			<b>Add new Admin </b><br><br>
			
			<a class="btn btn-large btn-success" href="addAdmin.php">Create Admin</a>
