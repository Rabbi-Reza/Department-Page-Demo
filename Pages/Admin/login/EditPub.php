...
include('connection.php');
 ...
 $link=mysqli_connect('localhost','root','','gm2019bu');
	 ...
	 $q="select * from publication where PuID = '$PuID'";
...
<body>
    ...
    <div>
       <!--Top Navigation bar Start-->
        ...
        <hr />
             ...
             <br />
              ...
              <!-- Middle Contents Start -->
			   <div class="col-lg-1"> <a class="btn btn-large btn-success" href="ahome.php">Admin Home </a></div> 
		
			  <div align="center"> 
				   
            <h2> Update the Publication data !! </h2>
            ...
            <hr />
			  ...
			  <div class="col-lg-8" >
             <h2><b>Publication Name : </b> <?php echo "$PuTitle"; ?> </h2> 
			 
			  <h3><b>Publication date : </b> <?php echo "$PuDate"; ?> </h3><br><br>
			  
			  <h4><b>Publication Journel : </b> <i><?php echo "$PuJour"; ?> </i></h4><br><br>
		...
		<?php echo "<a style='background-color: coral' class='btn btn-default 'href='EditPuData.php?Pdata=$PuID'> <b> Edit Data <b></a>" ; ?> 

		
		<?php echo "<a style='background-color: coral' class='btn btn-default 'href='changePdf.php?Cpdf=$PuID'> <b> Change the Pdf <b></a>" ; ?> 
		<br><br><br>
		
				<?php echo "<a  class='btn btn-default btn-success' href='FacTechPub.php?Pub=$id'> <b> Back <b></a>" ; ?> 
		
			  </div >
			  
			  
			  <div class="col-lg-4" >
			  <?php echo "<iframe src = '../../../Files/PDF/$PuPdf' width = '95%' height = '460'></iframe>"; ?> 
