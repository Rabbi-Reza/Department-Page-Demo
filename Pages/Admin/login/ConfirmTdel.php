    ...
    <div>
       <!--Top Navigation bar Start-->
        ...
        <hr />
            ...
            <h2> Confirm to delete the data of <b><?php echo "$tname"; ?> </b>?? </h2>
		...
		<?php echo "<a style='background-color: coral' class='btn btn-default 'href='deleteTech.php?delete=$conf'> <b> Yes , I am Confirm <b></a>" ; ?> 
