...
include('connection.php');
		...
		$q="select * from teacherGM where tcard ='$tcard'";
       ...
       <!--Top Navigation bar Start-->
        ...
        <hr />
            ...
            <h1> Add more Data  </h1>
				...
				<div > 
				<?php echo "<a style='background-color:#ff4d4d;color: black;font-size: 17px;font-weight: bold;' class='btn btn-large btn-success' href='FacTechAPub.php?id=$id'> Add Publication Data </a><br>"; ?> 
				
				 </div > 
			
		<br> <br>
				  <div > <a style="background-color:#ff4d4d;color: black;font-size: 17px;font-weight: bold;" class="btn btn-large btn-success" href="FacTechAPub.php"> Add Reasearch Data </a><br> </div> <br> <br>
				  
 
				  
				  <br> <br>
				  
				  <div > <a style="background-color:#ff4d4d;color: black;font-size: 17px;font-weight: bold;" class="btn btn-large btn-success" href="ahome.php"> Add Experience </a><br> </div>  <br>
				  
					 <hr>
					 
				 <div > <a class="btn btn-large btn-success" href="ahome.php"> Skip </a><br> </div> 
