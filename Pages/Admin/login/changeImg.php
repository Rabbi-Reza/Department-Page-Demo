    ...
    <div>
       <!--Top Navigation bar Start-->
        ...
        <hr />
            ...
            <h2> Confirm to Change the Image of <b><?php echo "$tname"; ?> </b>?? </h2>
			
			  <!-- Table Start -->

            <hr />
			
         <div  > <?php echo "<img class='img-circle'  src='../../../Files/Images/Faculty/$image' width='200' height='200'>"; ?> </div> 
		   
		    
			  <div  >
             <h3><b> <?php echo "$Desig"; ?> </b><br><br>
			  </div >
			  
			  
        <br>
		<form action="changeTech.php?Cimg=<?php echo "$conf";?>" method="post" >
	</form>
	
		<form action="changeTech.php?Cimg=<?php echo "$conf";?>" method="post" enctype="multipart/form-data" >
   <center> <input type="file" name="timg"> </center>
  <br>
   <input style="background-color:#ff4d4d;color: black;font-size: 17px;font-weight: bold;" class="btn btn-success" type="submit" value="Yes , Change the image">
   <br><br>
