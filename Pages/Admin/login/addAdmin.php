...
<body>
	...
	<form action="addAdminjob.php" method="post" >
	</form>
	
		<form action="addAdminjob.php" method="post" enctype="multipart/form-data">
		<table>
		
			<tr>
				<td width="200px" height="50px"><b>Enter Admin Name</b></td>
				<td width="200px" height="50px"><input type="text" name="adName" placeholder="Enter Admin Name"></td>
			</tr>
			
			<tr>
				<td width="200px" height="50px"><b>Enter Username</b></td>
				<td width="200px" height="50px"><input type="text" name="adUser" placeholder="Enter Username"></td>
			</tr>		
			
			<tr>
				<td width="200px" height="50px"><b>Email</b></td>
				<td width="200px" height="50px"><input type="email" name="adEmail" placeholder="Enter Email"></td>
			</tr>
			
			<tr>
				<td width="200px" height="50px"><b>Phone Number </b></td>
				<td width="200px" height="50px"><input type="text" name="adphn" placeholder="Enter Phone Number"></td>
			</tr>
			
			<tr>
				<td width="200px" height="50px"><b>Enter Password </b></td>
				<td width="200px" height="50px"><input type="text" name="adPass" placeholder="Enter Password"></td>
			</tr>
			
			<tr>
				<td width="200px" height="50px"><b>Enter Password Again </b></td>
				<td width="200px" height="50px"><input type="text" name="adagPass" placeholder="Enter Password Again "></td>
			</tr>
			...
			<tr>
				<td width="200px" height="50px"><b>Admin Type</b></td>
			...
			<tr>
				<td><b><input type="submit" name="Adsub" value="Create"></b></td>
			</tr>
		</table>
	</form>
