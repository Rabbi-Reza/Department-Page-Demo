        ...
        <hr />
            ...
            <h1> Description Data  </h1>
				 ...
				 <center>
				  ...
				  <?php echo "<a style='background-color:#ff4d4d;color: black;font-size: 17px;font-weight: bold;'class='btn btn-default' href='FacTechDeEd.php?des=$id'>Edit Data</a>"; ?> <br> <br>
